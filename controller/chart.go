...
func (ctrl *ChartController) ChartPie(c *gin.Context) {
	...
	scriptPath := filepath.Join(cwd, "controller/ChartProcessPyScripts", "draw_pie_chart.py")
...
func (ctrl *ChartController) ChartLine(c *gin.Context) {
	...
	scriptPath := filepath.Join(cwd, "controller/ChartProcessPyScripts", "draw_line_chart.py")
	cmd := exec.Command("python", scriptPath, string(paramsJSON))
	var out bytes.Buffer
	var stderr bytes.Buffer
	cmd.Stdout = &out
...
func (ctrl *ChartController) ChartBar(c *gin.Context) {
	...
	scriptPath := filepath.Join(cwd, "controller/ChartProcessPyScripts", "draw_bar_chart.py")
	cmd := exec.Command("python", scriptPath, string(paramsJSON))
	var out bytes.Buffer
	var stderr bytes.Buffer
	cmd.Stdout = &out
...
func (ctrl *ChartController) ChartLineBarMixed(c *gin.Context) {
	...
	scriptPath := filepath.Join(cwd, "controller/ChartProcessPyScripts", "draw_line_bar_mixed_chart.py")
	cmd := exec.Command("python", scriptPath, string(paramsJSON))
	var out bytes.Buffer
	var stderr bytes.Buffer
	cmd.Stdout = &out
